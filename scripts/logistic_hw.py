...
from datagen import random_linearly_separable_data
from logistic import logistic_gradient_descent
from error_measure import linear_Eout
...
def linsep_logistic(num_points=100, num_experiments=100, tol=0.01, eta=0.01, max_iter=1000):
    ...
    for i in range(num_experiments):
        ...
        E_out = linear_Eout(f, weights, bounds)
...
def test(num_points=100, tol=0.01, eta=0.01, max_iter=2000):
    ...
    print num, linear_Eout(f, w, bounds)
